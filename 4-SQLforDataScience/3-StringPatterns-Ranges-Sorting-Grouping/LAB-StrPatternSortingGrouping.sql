...
-- Query 5B: For each department retrieve the number of employees in the department, and the 
-- average employees salary in the department
SELECT DEP_ID, COUNT(DEP_ID) AS COUNT, AVG(SALARY) AS AVGSALARY
	FROM EMPLOYEES
	GROUP BY DEP_ID;
